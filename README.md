...
- **Analysis Ingestion:** Automatically parses completed LLM analysis files from the `analyses/` directory and updates the `sentinel5_memory.md` historical database with new fault categorizations and mitigations.
